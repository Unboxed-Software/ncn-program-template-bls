...
impl InitializeEpochState {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InitializeEpochStateInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct InitializeEpochStateInstructionData {
    discriminator: u8,
}
...
impl Default for InitializeEpochStateInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct InitializeEpochStateInstructionArgs {
    pub epoch: u64,
}

/// Instruction builder for `InitializeEpochState`.
///
/// ### Accounts:
///
///   0. `[]` epoch_marker
...
impl InitializeEpochStateBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = InitializeEpochStateInstructionArgs {
...
/// `initialize_epoch_state` CPI instruction.
pub struct InitializeEpochStateCpi<'a, 'b> {
    ...
    pub __args: InitializeEpochStateInstructionArgs,
}

impl<'a, 'b> InitializeEpochStateCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: InitializeEpochStateCpiAccounts<'a, 'b>,
        args: InitializeEpochStateInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `InitializeEpochState` via CPI.
///
/// ### Accounts:
///
///   0. `[]` epoch_marker
...
impl<'a, 'b> InitializeEpochStateCpiBuilder<'a, 'b> {
