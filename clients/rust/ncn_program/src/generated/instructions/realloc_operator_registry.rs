...
/// Accounts.
pub struct ReallocOperatorRegistry {
...
impl ReallocOperatorRegistry {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = ReallocOperatorRegistryInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct ReallocOperatorRegistryInstructionData {
    discriminator: u8,
}
...
impl Default for ReallocOperatorRegistryInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `ReallocOperatorRegistry`.
///
/// ### Accounts:
///
///   0. `[]` config
...
pub struct ReallocOperatorRegistryBuilder {
...
impl ReallocOperatorRegistryBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = ReallocOperatorRegistry {
...
/// `realloc_operator_registry` CPI accounts.
pub struct ReallocOperatorRegistryCpiAccounts<'a, 'b> {
...
/// `realloc_operator_registry` CPI instruction.
pub struct ReallocOperatorRegistryCpi<'a, 'b> {
...
impl<'a, 'b> ReallocOperatorRegistryCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ReallocOperatorRegistryCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ReallocOperatorRegistry` via CPI.
///
/// ### Accounts:
///
///   0. `[]` config
...
///   4. `[]` system_program
#[derive(Clone, Debug)]
pub struct ReallocOperatorRegistryCpiBuilder<'a, 'b> {
    instruction: Box<ReallocOperatorRegistryCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ReallocOperatorRegistryCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ReallocOperatorRegistryCpiBuilderInstruction {
            __program: program,
            config: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ReallocOperatorRegistryCpi {
...
#[derive(Clone, Debug)]
struct ReallocOperatorRegistryCpiBuilderInstruction<'a, 'b> {
