...
/// Accounts.
pub struct DistributeVaultRewards {
...
impl DistributeVaultRewards {
    pub fn instruction(
        &self,
        args: DistributeVaultRewardsInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = DistributeVaultRewardsInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct DistributeVaultRewardsInstructionData {
    discriminator: u8,
}
...
impl Default for DistributeVaultRewardsInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct DistributeVaultRewardsInstructionArgs {
    pub epoch: u64,
}

/// Instruction builder for `DistributeVaultRewards`.
///
/// ### Accounts:
///
...
///   6. `[writable]` operator_vault_reward_router
///   7. `[writable]` operator_vault_reward_receiver
///   8. `[optional]` system_program (default to `11111111111111111111111111111111`)
#[derive(Clone, Debug, Default)]
pub struct DistributeVaultRewardsBuilder {
...
impl DistributeVaultRewardsBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = DistributeVaultRewards {
        ...
        let args = DistributeVaultRewardsInstructionArgs {
...
/// `distribute_vault_rewards` CPI accounts.
pub struct DistributeVaultRewardsCpiAccounts<'a, 'b> {
...
/// `distribute_vault_rewards` CPI instruction.
pub struct DistributeVaultRewardsCpi<'a, 'b> {
    ...
    pub __args: DistributeVaultRewardsInstructionArgs,
}

impl<'a, 'b> DistributeVaultRewardsCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: DistributeVaultRewardsCpiAccounts<'a, 'b>,
        args: DistributeVaultRewardsInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DistributeVaultRewards` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` epoch_state
...
///   8. `[]` system_program
#[derive(Clone, Debug)]
pub struct DistributeVaultRewardsCpiBuilder<'a, 'b> {
    instruction: Box<DistributeVaultRewardsCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DistributeVaultRewardsCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DistributeVaultRewardsCpiBuilderInstruction {
            __program: program,
            epoch_state: None,
            config: None,
            ncn: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = DistributeVaultRewardsCpi {
...
#[derive(Clone, Debug)]
struct DistributeVaultRewardsCpiBuilderInstruction<'a, 'b> {
